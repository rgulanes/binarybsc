...
<h2>Scholarship Program</h2>
            ...
            <div class="col-lg-12" >
                <iframe class="form-control" style="height: 500px" id="iframepdf" src="<?php echo base_url().('assets/landingpage/pdf_files/scholarship.pdf');?>#page=1&zoom=100" frameborder="0" allowtransparency="true" ></iframe>
            </div>
