            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-newspaper-o fa-fw"></i> Newsfeeds</a>
                        </li>
                        <li>
                            <a href="tables.html"><i class="fa fa-image fa-fw"></i> Galleries</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#"> User Activity Tracking</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
